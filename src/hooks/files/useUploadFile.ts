...
import { CloudDirs, GenericStringVoidFunc, GenericVoidFunc } from 'types/global'
import useSignUpData from 'hooks/useSignUpData'

type ReturnType = {
  handleFileUpload: (
    onChange: GenericStringVoidFunc,
...
export default function useUploadFile(cloudDir: CloudDirs): ReturnType {
